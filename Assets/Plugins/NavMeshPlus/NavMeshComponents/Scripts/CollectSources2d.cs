...
namespace Plugins.NavMeshPlus.NavMeshComponents.Scripts
{
    ...
    public class CollectSources2d : NavMeshExtension
    {
        ...
        { get { return m_OverrideByGrid; } set { m_OverrideByGrid = value; } }

        [SerializeField]
        private GameObject m_UseMeshPrefab;

        public GameObject useMeshPrefab
        { get { return m_UseMeshPrefab; } set { m_UseMeshPrefab = value; } }

        [SerializeField]
        private bool m_CompressBounds;

        public bool compressBounds
        { get { return m_CompressBounds; } set { m_CompressBounds = value; } }

        [SerializeField]
        private Vector3 m_OverrideVector = Vector3.one;

        public Vector3 overrideVector
        { get { return m_OverrideVector; } set { m_OverrideVector = value; } }
