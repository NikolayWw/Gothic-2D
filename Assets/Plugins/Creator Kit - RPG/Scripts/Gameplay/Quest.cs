...
namespace Plugins.Creator_Kit___RPG.Scripts.Gameplay
{
    ...
    public class Quest : MonoBehaviour
    {
        ...
        private bool disableItemsOnStart = true;
        ...
        public Cutscene.Runtime.Cutscene introCutscenePrefab, outroCutscenePrefab;

        private List<GameObject> cleanup = new List<GameObject>();
