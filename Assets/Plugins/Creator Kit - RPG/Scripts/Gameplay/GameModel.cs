...
namespace Plugins.Creator_Kit___RPG.Scripts.Gameplay
{
    ...
    public class GameModel
    {
        ...
        private Dictionary<GameObject, HashSet<string>> conversations = new Dictionary<GameObject, HashSet<string>>();

        private Dictionary<string, int> inventory = new Dictionary<string, int>();
        private Dictionary<string, Sprite> inventorySprites = new Dictionary<string, Sprite>();

        private HashSet<string> storyItems = new HashSet<string>();
