...
namespace Plugins.Creator_Kit___RPG.Scripts.Tiles.Brushes.Tint_Brush_Smooth.Scripts
{
    [ExecuteInEditMode]
    public class TintTextureGenerator : MonoBehaviour
    {
        ...
        private GridInformation.Scripts.GridInformation GetGridInformation(Grid grid)
        {
