...
namespace Plugins.Creator_Kit___RPG.Editor
{
    ...
    {
        private static bool IzZoomed(Transform t)
        {
            return ((Camera.current.transform.position - t.position).magnitude <= 20);
        }

        [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected)]
        private static void DrawInventoryItemGizmos(InventoryItem ii, GizmoType gizmoType)
        {
        ...
        [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected)]
        private static void DrawStoryItemGizmos(StoryItem si, GizmoType gizmoType)
        {
        ...
        [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected)]
        private static void DrawQuestGizmos(Quest q, GizmoType gizmoType)
        {
