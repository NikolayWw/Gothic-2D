...
namespace Plugins.Creator_Kit___RPG.Scripts.Tiles.Brushes.GameObject_Brush.Scripts.Editor
{
    ...
    public class GameObjectBrush : GridBrushBase
    {
        ...
        { get { return m_Size; } set { m_Size = value; SizeUpdated(); } }
        public Vector3Int pivot
        { get { return m_Pivot; } set { m_Pivot = value; } }
        ...
        public class BrushCell
        {
            ...
            { get { return m_Scale; } set { m_Scale = value; } }
