using Plugins.Creator_Kit___RPG.Scripts.Tiles.Rule_Override_Tile.Scripts;
using System;
using System.Collections.Generic;
using UnityEngine;
using UnityEngine.Tilemaps;

namespace Plugins.Creator_Kit___RPG.Scripts.Tiles.Rule_Tile.Scripts
{
    ...
    public class RuleTile : TileBase
    {
        ...
        public class TilingRule
        {
            ...
            { Fixed, Rotated, MirrorX, MirrorY }

            public enum OutputSprite
            { Single, Random, Animation }
        }
