...
using Plugins.Creator_Kit___RPG.Scripts.Tiles.Rule_Tile.Scripts.Editor;
using System;
...
namespace Plugins.Creator_Kit___RPG.Scripts.Tiles.Rule_Override_Tile.Scripts.Editor
{
    [CustomEditor(typeof(RuleOverrideTile))]
    internal class RuleOverrideTileEditor : UnityEditor.Editor
    {
        public RuleOverrideTile overrideTile
        { get { return (target as RuleOverrideTile); } }
        ...
        private float k_DefaultElementHeight
        { get { return RuleTileEditor.k_DefaultElementHeight; } }
        private float k_PaddingBetweenRules
        { get { return RuleTileEditor.k_PaddingBetweenRules; } }
        private float k_SingleLineHeight
        { get { return RuleTileEditor.k_SingleLineHeight; } }
        private float k_LabelWidth
        ...
        public void DrawOriginalRuleElement(Rect rect, RuleTile.TilingRule originalRule, bool isDefault = false)
        {
            using (new EditorGUI.DisabledScope(true))
            {
                ...
                RuleTileEditor ruleTileEditor = UnityEditor.Editor.CreateEditor(overrideTile.m_Tile) as RuleTileEditor;
